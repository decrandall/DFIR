...
$groupedresults = $autorunscCompiled | ?{$_.Signer -notlike "(Verified)*" -and $_."Image Path" -notlike "File not found*"}| group "Image Path","Launch String","Md5"
...
Kansa Script Get-ASEPImagePathLaunchStringMD5UnsignedTimeStack.ps1 needs a dependency "logparser.exe" and it's not really needed
...
$results = $groupedresults |  Select @{n="ct";e={$_.count}},@{n="Time";e={@($_.group."Time")[0]}}, @{n="Image Path";e={@($_.group."Image Path")[0]}},@{n="Launch String";e={@($_.group."Launch String")[0]}},@{n="MD5";e={@($_.group."MD5")[0]}},@{n="Signer";e={@($_.group."Signer")[0]}}

#change the output file name below if you like

$results | sort ct | Export-Csv -NoTypeInformation .\asep-workstation-timestack.csv
